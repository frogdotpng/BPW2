...
public class EventManager : MonoBehaviour
{
    ...
    [Header("MainMenuThings")]
    [SerializeField] public GameObject MainMenuDay;
    [SerializeField] public GameObject MainMenuNight;
    [SerializeField] public GameObject MainMenuRed;
    ...
    private void SwitchToNight()
    {
        ...
        MainMenuDay.SetActive(false);
        MainMenuNight.SetActive(true);
        MainMenuRed.SetActive(false);
    ...
    private void SwitchToDay()
    {
        ...
        MainMenuDay.SetActive(true);
        MainMenuNight.SetActive(false);
        MainMenuRed.SetActive(false);
